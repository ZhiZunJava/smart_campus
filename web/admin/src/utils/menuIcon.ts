...
export const menuIconOptions: MenuIconOption[] = [
  ...
  { label: '概览仪表盘', value: 'ri-dashboard-3-line', group: '校园', legacy: ['dashboard'], keywords: ['首页', '概览', 'dashboard'] },
  ...
  { label: '校园学习', value: 'ri-graduation-cap-line', group: 'AI', legacy: ['campus'], keywords: ['智慧校园', '校园'] },
