<template>
  <div class="app-container">
    ...
    <el-row :gutter="16">
      <el-col :span="6"><el-card><div class="label">课程数</div><div class="value">{{ data.courseCount || 0 }}</div></el-card></el-col>
      <el-col :span="6"><el-card><div class="label">班级数</div><div class="value">{{ data.classCount || 0 }}</div></el-card></el-col>
      <el-col :span="6"><el-card><div class="label">资源数</div><div class="value">{{ data.resourceCount || 0 }}</div></el-card></el-col>
      <el-col :span="6"><el-card><div class="label">题目数</div><div class="value">{{ data.questionCount || 0 }}</div></el-card></el-col>
    </el-row>
  </div>
</template>
...
<style scoped>.mb16{margin-bottom:16px}.label{color:var(--el-text-color-secondary)}.value{font-size:28px;font-weight:700;color:var(--el-color-primary)}</style>
