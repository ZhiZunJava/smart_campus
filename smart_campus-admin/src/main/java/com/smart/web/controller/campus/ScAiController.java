...
{
    @Autowired private IScAiModelConfigService scAiModelConfigService;
    @Autowired private IScAiPromptTemplateService scAiPromptTemplateService;
    @Autowired private IScAiTaskLogService scAiTaskLogService;
    @Autowired private IAiGatewayService aiGatewayService;
    ...
    {
        ScAiPromptTemplate template = scAiPromptTemplateService.selectScAiPromptTemplateByTemplateId(testDto.getTemplateId());
        if (template == null)
        {
