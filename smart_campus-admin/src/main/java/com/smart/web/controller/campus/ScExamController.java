...
public class ScExamController extends BaseController
{
    ...
    @Autowired private IScExamAnswerService scExamAnswerService;
    @Autowired private IScWrongQuestionBookService scWrongQuestionBookService;
    ...
    public AjaxResult submitExamDto(@RequestBody ExamSubmitDto submitDto)
    {
        ...
        List<Map<String, Object>> answers = submitDto.getAnswers() == null
            ...
            : submitDto.getAnswers().stream()
                .map(item -> Map.<String, Object>of("questionId", item.getQuestionId(), "userAnswer", item.getUserAnswer()))
