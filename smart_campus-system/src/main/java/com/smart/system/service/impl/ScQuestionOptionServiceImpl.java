...
public class ScQuestionOptionServiceImpl implements IScQuestionOptionService {
    ...
    public ScQuestionOption selectScQuestionOptionByOptionId(Long optionId) {
        return scQuestionOptionMapper.selectScQuestionOptionByOptionId(optionId);
    }

    public List<ScQuestionOption> selectScQuestionOptionList(ScQuestionOption scQuestionOption) {
        return scQuestionOptionMapper.selectScQuestionOptionList(scQuestionOption);
    }
    ...
    public int deleteScQuestionOptionByOptionIds(Long[] optionIds) {
        return scQuestionOptionMapper.deleteScQuestionOptionByOptionIds(optionIds);
    }

    public int deleteScQuestionOptionByOptionId(Long optionId) {
        return scQuestionOptionMapper.deleteScQuestionOptionByOptionId(optionId);
    }

    public int deleteScQuestionOptionByQuestionId(Long questionId) {
        return scQuestionOptionMapper.deleteScQuestionOptionByQuestionId(questionId);
    }
}
