...
public class ExamPaperDetailVo
{
    ...
    public List<ExamPaperQuestionDetailVo> getQuestions() { return questions; }
    public void setQuestions(List<ExamPaperQuestionDetailVo> questions) { this.questions = questions; }
}
